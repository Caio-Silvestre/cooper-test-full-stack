...
exports.CreateUserAndTaskTables1752191685342 = void 0;
class CreateUserAndTaskTables1752191685342 {
    name = 'CreateUserAndTaskTables1752191685342';
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "tasks" ("id" SERIAL NOT NULL, "title" character varying(250) NOT NULL, "status" boolean NOT NULL, "user_id" integer, CONSTRAINT "PK_8d12ff38fcc62aaba2cab748772" PRIMARY KEY ("id"))`);
...
exports.CreateUserAndTaskTables1752191685342 = CreateUserAndTaskTables1752191685342;
//# sourceMappingURL=1752191685342-CreateUserAndTaskTables.js.map