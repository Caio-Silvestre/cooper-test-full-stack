...
function useTasks() {
    ...
    async function fetchTaskById(id) {
        ...
        try {
            ...
            const error = e;
            setError(error.response?.data?.message || "Erro ao buscar task");
            return null;
        } finally{
            setLoading(false);
        }
    ...
    async function updateTask(id, updates) {
        ...
        try {
            ...
            const error = e;
            setError(error.response?.data?.message || "Erro ao atualizar task");
            return null;
        } finally{
            setLoading(false);
        }
    ...
    async function deleteTask(id) {
        ...
        try {
            ...
            const error = e;
            setError(error.response?.data?.message || "Erro ao deletar task");
            return false;
        } finally{
            setLoading(false);
        }
    ...
    async function reorderTasks(tasks) {
        ...
        try {
            ...
            const error = e;
            setError(error.response?.data?.message || "Erro ao reordenar tasks");
            return false;
        } finally{
            setLoading(false);
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__88dd26a8._.js.map