...
function useTasks() {
    ...
    async function fetchTasks() {
        ...
        try {
            ...
            const error = e;
            setError(error.response?.data?.message || "Erro ao buscar tasks");
        } finally{
            setLoading(false);
        }
    }
    ...
    async function createTask(task) {
        ...
        try {
            ...
            const error = e;
            setError(error.response?.data?.message || "Erro ao criar task");
            return null;
        } finally{
            setLoading(false);
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e06c6b89._.js.map