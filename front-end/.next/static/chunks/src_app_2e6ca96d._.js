...
function LoginModal({ show, onClose }) {
    ...
    async function handleRegister(e) {
        ...
        if (res.ok) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Erro ao cadastrar usuário");
        }
    }
...
_s(LoginModal, "OU9PrEb6y5fe/QzF+5jh9Y4YoX0=", false, function() {
    return [
...
function useContact() {
    ...
    async function sendContact(form) {
        ...
        setError(null);
        try {
            const res = await fetch(`${("TURBOPACK compile-time value", "http://localhost:3001")}/contact`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
                },
...
//# sourceMappingURL=src_app_2e6ca96d._.js.map